...
class MyTxt(ft.TextButton):
    def __init__(self, val, mypage):
    ...
    def clicked(self,e):
        print(e)  
        print(self.mypage)
        self.text = self.text+'qwe'
        self.update()
        self.mypage.window.height=200
        # super().update()
        e.page.update()
...
def main(page: ft.Page):
    ...
    mytxt =MyTxt('my test???',mypage=page)
    # print(mytxt.txt)
    # mytxt.on_click=mytxt.click

    # Создаем пример DataFrame с разными типами данных
    data = {
        "ID": [1, 2, 3, 4, 5],
        "Name": [mytxt.text, "Item 2", "Item 3", "Item 4", "Item 5"],
        "Description": [
